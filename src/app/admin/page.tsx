...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log("Cleaning up activity effect");
    };
  ...
  const handleAddActivity = async () => {
    try {
      ...
      alert(`Failed to add activity: ${message}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleUpdateActivity = async () => {
    try {
      ...
      const message = error instanceof Error ? error.message : "Unknown error";
      alert(`Failed to update activity: ${message}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-1/2 mt-6 p-4 border rounded-lg bg-white shadow-sm">
